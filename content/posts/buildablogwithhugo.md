...
### 安装主题
hugo生成的默认目录是不带主题的，这挺适合我这种喜欢自己配置的。进入刚刚创建的目录，在[这里](https://themes.gohugo.io/)选择一个你喜欢的主题。 **注意：每个主题都是不一样的，请仔细阅读对应主题的 readme 文档** 惠狐之书使用的是 hyde-Y 主题，~~这个主题看起来有点像比特垃圾桶~~ , 所以下文将以这个主题为示例。  
按照主题写的命令
```bash
$ cd your_site_repo/
$ mkdir themes
